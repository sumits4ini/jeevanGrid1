...
export const CommandCenterOverview: React.FC<CommandCenterOverviewProps> = ({ initialStatus }) => {
  ...
  return (
    <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 gap-3">
      {/* 1. Active Incidents */}
      <div className="p-3.5 rounded-xl bg-surface-100/90 border border-surface-border flex flex-col justify-between shadow-md">
        ...
        <div className="mt-2">
          ...
          <span className="text-[10px] text-amber-400 font-mono">Assam Basin Active</span>
        </div>
      </div>
      ...
      <div className="p-3.5 rounded-xl bg-rose-500/10 border border-rose-500/30 flex flex-col justify-between shadow-md">
        ...
        <div className="mt-2">
          ...
          <span className="text-[10px] text-rose-400 font-mono">DEFCON 1 Flash Flood</span>
        </div>
      </div>
