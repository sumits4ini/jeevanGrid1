  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        className="relative p-2 rounded-xl bg-surface-100 hover:bg-surface-200 border border-surface-border text-slate-300 hover:text-slate-100 transition-colors"
        ...
        <div className="absolute right-0 mt-2 w-80 sm:w-96 rounded-2xl bg-surface-100 border border-surface-border shadow-2xl z-50 p-4 space-y-3">
          <div className="flex items-center justify-between pb-2 border-b border-surface-border">
            <div className="flex items-center gap-2">
              <span className="text-sm font-bold text-slate-100">Incident Command Center</span>
              {data.unread_count > 0 && (
              ...
              data.notifications.map((notif) => (
                <div
                  ...
                  className={`p-3 rounded-xl border transition-all text-xs ${
                    notif.is_read
                      ? "bg-surface-200/50 border-surface-border/60 opacity-60"
                      : "bg-surface-200 border-cyan-500/30"
                  }`}
                >
